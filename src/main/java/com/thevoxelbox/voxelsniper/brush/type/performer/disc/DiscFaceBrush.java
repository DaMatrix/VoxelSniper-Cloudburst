	...
	public void handleCommand(String[] parameters, Snipe snipe) {
		...
		for (String parameter : parameters) {
			if (parameter.equalsIgnoreCase("info")) {
				messenger.sendMessage(TextFormat.GOLD + "Disc Face brush Parameters:");
				messenger.sendMessage(TextFormat.AQUA + "/b df true -- will use a true circle algorithm instead of the skinnier version with classic sniper nubs. /b b false will switch back. (false is default)");
				return;
			}
