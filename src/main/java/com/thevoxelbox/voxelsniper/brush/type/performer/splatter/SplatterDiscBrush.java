		...
		for (String parameter : parameters) {
			if (parameter.equalsIgnoreCase("info")) {
				snipe.createMessageSender()
					.message(TextFormat.GOLD + "Splatter Disc brush Parameters:")
					.message(TextFormat.AQUA + "/b sd s[int] -- set a seed percentage (1-9999). 100 = 1% Default is 1000")
					.message(TextFormat.AQUA + "/b sd g[int] -- set a growth percentage (1-9999).  Default is 1000")
					.message(TextFormat.AQUA + "/b sd r[int] -- set a recursion (1-10).  Default is 3")
					.send();
				return;
